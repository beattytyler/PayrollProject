...
class PayrollCalendar:
    ...
    def switch_shifts(self, employee_id_1, employee_id_2, date_1, date_2):
        try:
            if employee_id_1 in self.employees and employee_id_2 in self.employees:
                ...
                print(f"One or both employee IDs {employee_id_1} and {employee_id_2} not found.")
        except Exception as e:
    ...
    def initialize_employees(self):
        try:
            ...
            print(f"Error initializing employees: {e}")
    ...
    def get_employee_work_schedule(self, employee_id):
        try:
            ...
            print(f"Error getting employee work schedule: {e}")
    ...
    def is_workday(self, employee_id, date):
        try:
            ...
            print(f"Error checking if it's a workday: {e}")
    ...
    def get_work_hours(self, employee_id, date):
        try:
            ...
            print(f"Error getting work hours: {e}")
...
class PayrollApp:
    def __init__(self, root):
        try:
            ...
            self.root = root
            self.root.title("Wolf Payroll - Northfield")
            ...
            print(f"Error initializing PayrollApp: {e}")
        ...
        try:
            ...
            try:
                ...
                if hours > 0:
                    ...
                    print(f"No hours to be removed for Employee ID {employee_id} on {date}.")
            except ValueError:
                print(f"Invalid date format. Please use MM/DD/YYYY.")
    ...
    def update_payroll_display(self):
        try:
            ...
            print(f"Error updating payroll display: {e}")
...
class PayrollApp:
    ...
    def export_payroll_to_file(self):
        start, end = self.payroll_calendar.current_pay_period()
        filename = r"C:\Users\tyler\OneDrive\Desktop\northfield_payroll_report.txt"
        ...
        try:
            ...
            print(f"Payroll successfully exported to {filename}")
